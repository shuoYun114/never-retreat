...
const Progression=(()=>{
const CATALOG=[
 {id:'springfield',name:'春田 M1903A4',kind:'sniper',cost:650,classes:[3],desc:'狙击手专用 · 高伤害'},
 {id:'kar98zf',name:'Kar98k ZF41',kind:'sniper',cost:720,classes:[3],desc:'狙击手专用 · 4×瞄准'},
 {id:'stg44',name:'STG 44',kind:'assault',cost:700,classes:[1,2],desc:'冲锋枪手/突击兵 · 全自动'},
 {id:'bar',name:'BAR 自动步枪',kind:'rifle',cost:560,classes:[0,2],desc:'步枪兵/突击兵 · 高火力'},
 {id:'p38',name:'瓦尔特 P38',kind:'pistol',cost:260,classes:[0,1,2,3,4,5,6,7],desc:'全兵种副武器'},
 {id:'scope_4x',name:'4× 瞄准镜',kind:'attachment',cost:220,desc:'栓动步枪可装 · 自带瞄具的除外'},
 {id:'silencer',name:'消音器',kind:'attachment',cost:180,desc:'栓动/全自动/手枪可装 · 伤害-8%'},
 {id:'extended_mag',name:'扩容弹匣',kind:'attachment',cost:200,desc:'带弹匣的枪可装 · 容量+35%'},
 {id:'stock',name:'稳定枪托',kind:'attachment',cost:160,desc:'长枪可装 · 后坐-18%'}
];
